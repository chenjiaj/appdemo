...
function detailLoad(){
    ...
    if(window.detailLoadObj){
        window.detailLoadObj.renderPage();
    }else{
        window.detailLoadObj = {
            content:$(".item-intro"),
            init:function(){
                this.renderPage();
                this.bindEvent();
            ...
            bindEvent:function(){
                this.content.on('click','.all-monitor',function(e){
                    e.preventDefault();
                ...
                this.content.on('click','.open-monitor',function(e){
                    e.preventDefault();
                    window.itemID =  $(this).closest(".item").attr("data-id");//传递查询的项目ID
                    window.name = $(this).closest(".item").attr("data-name");//传递查询的项目名称
                ...
                this.content.on('click','.warn-monitor',function(e){
                    e.preventDefault();
                    window.itemID =  $(this).closest(".item").attr("data-id");//传递查询的项目ID
                    window.name = $(this).closest(".item").attr("data-name");//传递查询的项目名称
